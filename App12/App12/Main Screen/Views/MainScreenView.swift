...
class MainScreenView: UIView {
    ...
    func setupTableViewContacts() {
        ...
        tableViewContacts.register(
            ...
            forCellReuseIdentifier: Configs.tableViewContactsID)
    ...
    func setupFloatingButtonAddContact() {
        ...
        floatingButtonAddContact.setImage(
            UIImage(systemName: "person.crop.circle.fill.badge.plus")?
        ...
        floatingButtonAddContact.translatesAutoresizingMaskIntoConstraints =
            false
    ...
    func initConstraints() {
        NSLayoutConstraint.activate([
            ...
            profilePic.topAnchor.constraint(
                equalTo: self.safeAreaLayoutGuide.topAnchor, constant: 8),
            profilePic.leadingAnchor.constraint(
            ...
            labelText.leadingAnchor.constraint(
                equalTo: profilePic.trailingAnchor, constant: 8),

            tableViewContacts.topAnchor.constraint(
                equalTo: profilePic.bottomAnchor, constant: 8),
            ...
            floatingButtonAddContact.widthAnchor.constraint(
                equalToConstant: 48),
            floatingButtonAddContact.heightAnchor.constraint(
                equalToConstant: 48),
            floatingButtonAddContact.bottomAnchor.constraint(
                equalTo: self.safeAreaLayoutGuide.bottomAnchor, constant: -16),
            floatingButtonAddContact.trailingAnchor.constraint(
                equalTo: self.safeAreaLayoutGuide.trailingAnchor, constant: -16),
