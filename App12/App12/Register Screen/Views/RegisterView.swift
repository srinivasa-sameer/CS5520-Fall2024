...
class RegisterView: UIView {
    ...
    func setupbuttonTakePhoto() {
        ...
        buttonTakePhoto.setImage(
            UIImage(systemName: "camera.fill")?.withRenderingMode(
    ...
    func initConstraints() {
        NSLayoutConstraint.activate([
            ...
            textFieldName.centerXAnchor.constraint(
            ...
            textFieldEmail.topAnchor.constraint(
            ...
            labelPhoto.topAnchor.constraint(
                equalTo: buttonTakePhoto.bottomAnchor),
            labelPhoto.centerXAnchor.constraint(
                equalTo: self.safeAreaLayoutGuide.centerXAnchor),

            buttonRegister.topAnchor.constraint(
                equalTo: labelPhoto.bottomAnchor, constant: 32),
